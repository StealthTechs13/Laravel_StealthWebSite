@include('layouts.header')
        ...
        <div class="page-title-section section section-padding-top" data-bg-color="#000" data-overlay="0.7" data-bg-image="{{asset('public/assets/images/bg/breadcrumb-bg-three.jpg')}}">
            ...
            <div class="page-breadcrumb position-static">
                <div class="container">
                    <ul class="breadcrumb justify-content-center">
                        <li><a href="{{url('work-details')}}">Home</a></li>
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb-n6 icon-box-shape-animation">
                    ...
                    <div class="col mb-6" data-aos="fade-up">
                        ...
                        <div class="icon-box box-border text-center" data-vivus-hover>
                            <div class="icon"><img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-basic-target.svg')}}" alt=""></div>
                            <div class="content">
                    ...
                    <div class="col mb-6" data-aos="fade-up">
                        ...
                        <div class="icon-box box-border text-center" data-vivus-hover>
                            <div class="icon"><img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-basic-gear.svg')}}" alt=""></div>
                            <div class="content">
                    ...
                    <div class="col mb-6" data-aos="fade-up">
                        ...
                        <div class="icon-box box-border text-center" data-vivus-hover>
                            <div class="icon"><img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-basic-display.svg')}}" alt=""></div>
                            <div class="content">
                    ...
                    <div class="col mb-6" data-aos="fade-up">
                        ...
                        <div class="icon-box box-border text-center" data-vivus-hover>
                            <div class="icon"><img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-ecommerce-cart-plus.svg')}}" alt=""></div>
                            <div class="content">
                    ...
                    <div class="col mb-6" data-aos="fade-up">
                        ...
                        <div class="icon-box box-border text-center" data-vivus-hover>
                            <div class="icon"><img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-basic-picture-multiple.svg')}}" alt=""></div>
                            <div class="content">
                    ...
                    <div class="col mb-6" data-aos="fade-up">
                        ...
                        <div class="icon-box box-border text-center" data-vivus-hover>
                            <div class="icon"><img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-basic-picture.svg')}}" alt=""></div>
                            <div class="content">
                    ...
                    <div class="shape shape-1 scene">
                        <span data-depth="1"><img src="{{asset('public/assets/images/shape-animation/video-shape-1.png')}}" alt=""></span>
                    </div>
                    <!-- Animation Shape End -->
        ...
        <!-- Skill Section Start -->
        <div class="section section-padding-top skill-section-padding-bottom" data-bg-color="#f8faff">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-6 order-lg-1 order-2">
                        ...
                        <div class="progressbar-area mt-lg-0 mt-md-50 mt-sm-50 mt-40">
                            ...
                            <div class="section-title-two">
                                ...
                                <h3 class="title">Bringing unique and engaging experiences to your brand</h3>
                            </div>
                    ...
                    <div class="offset-xl-1 col-xl-6 col-lg-6 order-lg-2 order-1">
                        ...
                        <div class="about-image-area right-0 skill-image-area">
                            <div class="about-image js-tilt">
                                <img src="{{asset('public/assets/images/skill/skill-1.jpg')}}" alt="">
                            </div>
                            <div class="about-image js-tilt">
                                <img src="{{asset('public/assets/images/skill/skill-2.jpg')}}" alt="">
                            </div>
                            <!-- Animation Shape Start -->
                            <div class="shape shape-1 scene">
                                <span data-depth="1"><img src="{{asset('public/assets/images/shape-animation/video-shape-1.png')}}" alt=""></span>
        ...
        <!-- About Section Start -->
        <div class="section section-padding-top technology-section-padding-bottom-180">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 col-12" data-aos="fade-up">
                        <div class="about-image-area">
                            <div class="about-image js-tilt">
                                <img src="{{asset('public/assets/images/about/about-5.jpg')}}" alt="">
                            </div>
                            <div class="about-image js-tilt">
                                <img src="{{asset('public/assets/images/about/about-6.jpg')}}" alt="">
                            </div>
                            <!-- Animation Shape Start -->
                            <div class="shape shape-1 scene">
                                <span data-depth="1"><img src="{{asset('public/assets/images/shape-animation/about-shape-1.png')}}" alt=""></span>
                            </div>
                            <!-- Animation Shape End -->
                        </div>
                    </div>
        ...
        <div class="section section-padding contact-section" data-bg-color="#000" data-overlay="0.7" data-bg-image="{{asset('public/assets/images/bg/contact-bg.jpg')}}">
                ...
                <div class="row row-cols-lg-2 row-cols-1 align-items-center">
                    <div class="col">
                        ...
                        <div class="contact-Information mr-xl-7">
                            ...
                            <div class="contact-info info-light" data-vivus-hover>
                                <div class="icon">
                                    <img class="svgInject" src="{{asset('public/assets/images/svg/linea/linea-basic-message-txt.svg')}}" alt="">
                                </div>
                                <div class="info">
                    ...
                    <div class="col mt-lg-0 mt-md-10 mt-8">
                        ...
                        <div class="contact-form-area">
                            ...
                            <div class="shape shape-1 scene">
                                <span data-depth="1">
                                    <img src="{{asset('public/assets/images/shape-animation/contact-shape.png')}}" alt="">
                                </span>
                            </div>
                            <!-- Animation Shape End -->
                        </div>
